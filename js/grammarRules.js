...
(function (global) {
  ...
  const SIFA_SILA_INTRO = {
    ...
    text:
      'בשני המקרים בא אחרי שם עצם ("השם הזוקק") משפט נוסף שמתאר או משלים אותו. ההבדל נקבע לפי יידוע השם: אם הוא מיודע - המשפט מחובר אליו דרך כינוי זיקה (اسم الموصول) שמתאים לו במין ובמספר, וזהו "משפט צלה". אם הוא לא מיודע (נכ\'רה) - המשפט מתאר אותו ישירות, בלי שום כינוי זיקה, וזהו "משפט צפה".',
  };
  ...
  const IRAB_INTRO = {
    title: "מה זה ניקוד סופי (الإعراب)?",
    text:
      'שמות עצם רבים בערבית משנים את הניקוד באות האחרונה שלהם לפי תפקידם התחבירי במשפט - נושא, מושא ישיר, או סומך/מושא עקיף. זהו "הניקוד הסופי" (الإعراب). הטבלה שלהלן מסכמת את שלושת מצבי היחסה ואיך הם באים לידי ביטוי בשם רגיל (מיודע/לא מיודע), בריבוי שלם זכר ובזוגי - כולל הצורה המקוצרת (בלי ن) כשהשם סומך או מחובר לכינוי שייכות.',
  };
